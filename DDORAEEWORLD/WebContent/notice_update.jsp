...
<body>
	...
	<div class="container">
		<div class="row">
			<form method="post" action="notice_updateProc.jsp?notice_seq=<%= notice_seq %>">
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd;">
					<thead>
						<tr>
							<th colspan="2" style="background-color: black; text-align: center;">공지글 수정</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td><input type="text" class="form-control" placeholder="글 제목" name="notice_title" maxlength="50" value=<%= notice.getNotice_title() %>></td>
						</tr>
						<tr>
							<td><textarea class="form-control" placeholder="내용" name="notice_content" maxlength="4096" style="height: 350px; width: 1150px;"><%= notice.getNotice_content() %></textarea></td>
						</tr>
					</tbody>
				</table>
				<center>
					<input type="submit" value="수정" style="background-color: black; color: white; border-color: white;">
